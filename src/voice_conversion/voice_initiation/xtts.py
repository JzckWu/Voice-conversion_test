...
# can you reconfigure this code? how to poetry add the tts library and also remove the youtube video downloading thing. also if possibel can it use ogg files directly? thats whats on the website so.